          ...
          <div className="flex items-center w-2/3 gap-x-10 justify-end">
            <form action="" className="relative flex items-center">
              ...
              <Button
                ...
                size={"icon"}
                className={
                  "absolute transition-all text-base ml-3 font-bold text-[hsl(26,58%,23%)] peer-hover:bg-white peer-focus:right-2 peer-focus:text-white peer-focus:bg-[#5E3719]"
                }>
                <FaSearch />
              </Button>
            </form>
            <Button
              variant={"ghost"}
              size={"icon"}
              className={"text-[#5E3719] hover:text-[#5E3719] text-xl"}>
              <HiShoppingCart />
            </Button>
